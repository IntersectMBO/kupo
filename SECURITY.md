...
The kupo project is committed to ensuring the security of
...
If you discover a security vulnerability in kupo, we encourage you to
...
- The version of kupo where the vulnerability exists.
...
The kupo project greatly appreciates the assistance of the security
